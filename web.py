...
add_bg_from_local('G:\VS_Code\ATS_SCORE_CHECKER_PROJECT\Background.jpg')  # Use a high-quality background image
            ...
            if response_json:
                ...
                with st.expander("Show Evaluation Results"):
                    ...
                    st.markdown("""
                        ...
                        """, unsafe_allow_html=True)
                    st.write(get_gemini_response(f"Identify missing keywords.\n\nresume: {resume_text}\njob_description: {job_description}"))
                    ...
                    st.markdown("""
                        ...
                        """, unsafe_allow_html=True)
                    st.write(get_gemini_response(f"Provide a summary and suggest improvements.\n\nresume: {resume_text}\njob_description: {job_description}"))
